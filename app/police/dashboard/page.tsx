    ...
    <div className="min-h-screen bg-slate-100 flex flex-col">
      ...
      <div className="bg-slate-900 text-white py-2 px-6 text-[10px] uppercase tracking-[0.2em] font-bold flex justify-between items-center z-50">
        ...
        <div className="hidden md:flex gap-4">
          <span>Regional Investigation Command Center</span>
        </div>
      </div>
            ...
            <div className="p-4 border-t border-slate-800">
               <div className="bg-slate-950 p-4 border border-slate-800 mb-4 rounded-lg">
                  <div className="flex items-center gap-3 mb-2">
                     ...
                     <div>
                        <p className="text-[10px] font-black text-white uppercase tracking-tight">{user?.region} Division</p>
                        <p className="text-[8px] font-bold text-slate-500 uppercase tracking-widest">Active Command</p>
                     </div>
                  </div>
               </div>
               <button 
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between">
                       <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest flex items-center gap-2">
                          <BarChart3 className="w-5 h-5 text-cyan-500" /> Regional Case Ledger
                       </h3>
                       <div className="flex items-center gap-4">
                                   ...
                                   <tr key={fir.id} className="hover:bg-slate-50/50 transition-colors group">
                                      ...
                                      <td className="py-5 px-6 text-right">
                                         <Link href={`/police/fir/${fir.id}`}>
                                            <Button variant="ghost" className="h-10 px-4 text-slate-900 hover:bg-slate-900 hover:text-white font-black text-[10px] uppercase tracking-widest border-2 border-slate-900 rounded-none transition-all flex items-center gap-2 ml-auto shadow-sm hover:shadow-lg">
                                               Review File <ChevronRight className="w-4 h-4" />
                                            </Button>
                                         </Link>
                                      </td>
                                   </tr>
